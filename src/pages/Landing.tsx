...
const Landing = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(223,189,105,0.1),transparent_80%)]"></div>
      ...
      <div className="fixed pointer-events-none inset-0 overflow-hidden">
        <div className="absolute -top-20 -left-20 w-40 h-40 rounded-full bg-gold/5 blur-3xl animate-float-slow"></div>
        <div className="absolute top-1/4 -right-20 w-60 h-60 rounded-full bg-gold/5 blur-3xl animate-float"></div>
        <div className="absolute bottom-1/3 -left-10 w-32 h-32 rounded-full bg-gold/5 blur-3xl animate-float-reverse"></div>
      </div>
    </div>
  );
};
